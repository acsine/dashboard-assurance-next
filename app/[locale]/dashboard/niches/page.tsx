      ...
      {canManage && (
        <Card>
          ...
          <CardContent className="grid gap-3 md:grid-cols-3">
            ...
            <Input placeholder="Catégorie (ex. moto-taxi)" value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })} />
            ...
            <Input placeholder="Téléphone" value={form.contact_phone} onChange={(e) => setForm({ ...form, contact_phone: e.target.value })} />
            <Input placeholder="Description" value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} />
            <Input type="number" placeholder="Prime spéciale" value={form.special_bonus_amount} onChange={(e) => setForm({ ...form, special_bonus_amount: e.target.value })} />
            <select className="h-10 rounded-md border px-3 text-sm" value={form.bonus_type} onChange={(e) => setForm({ ...form, bonus_type: e.target.value as 'FCFA' | 'POINTS' })}>
            ...
            <div className="flex gap-2">
              ...
              {edit && (
                <Button variant="outline" onClick={() => { setEdit(null); setForm(emptyForm) }}>
                  Annuler
                </Button>
              )}
            </div>
